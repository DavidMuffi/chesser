...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_COORD = 4,                      /* COORD  */
  YYSYMBOL_CAPTURE = 5,                    /* CAPTURE  */
  YYSYMBOL_CASTLE_SHORT = 6,               /* CASTLE_SHORT  */
  YYSYMBOL_CASTLE_LONG = 7,                /* CASTLE_LONG  */
  YYSYMBOL_CHECK = 8,                      /* CHECK  */
  YYSYMBOL_CHECKMATE = 9,                  /* CHECKMATE  */
  YYSYMBOL_YYACCEPT = 10,                  /* $accept  */
  YYSYMBOL_input = 11,                     /* input  */
  YYSYMBOL_movs = 12,                      /* movs  */
  YYSYMBOL_mov = 13                        /* mov  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "PIECE", "COORD",
  "CAPTURE", "CASTLE_SHORT", "CASTLE_LONG", "CHECK", "CHECKMATE",
  "$accept", "input", "movs", "mov", YY_NULLPTR
};
...
{
       2,     0,     1,     0,     7,     9,    10,     3,     4,     6,
       0,    11,    12,     5,    13,    14,     8,    15,    16
};
...
{
       2,    14,    15,     3,     4,     9,     5,     6,     3,     4,
      13,     5,     6,    10,    17,    18,    11,    12,    16
};
